...
const ShopInfoScreen = ({ route, navigation }) => {
    ...
    const { title, workHours, uri, icon, location, coordinates, phonenumber, color, rating, email, website } = route.params;
    return (
        <Container>
                ...
                <ScrollView style={styles.main}>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <TouchableOpacity
                            ...
                            style={{
                                alignItems: 'center', flexDirection: 'row', backgroundColor: color, height: 40,
                                borderRadius: 24, padding: 10, margin: 20, elevation: 10, paddingStart: 24, paddingEnd: 24,
                            }}
                        >
                            <Icon style={{ color: 'white', marginEnd: 10 }} name="md-planet" size={24} color="#fff" />
                            <Text style={{ fontSize: 18, color: '#fff' }}>{t('Website')}</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ alignItems: 'center' }}>
                        <View
